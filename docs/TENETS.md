...
**one best frame per event** so near-duplicates don't cause fatigue or overfitting.
Auth-optional, but capable of the source's strict auth. <sub>ADR-0005, 0006, 0010</sub>
...
0007→6, 0008→5/6, 0009→3, 0010→4, 0011→5, 0012→3, 0013→6, 0014→5.
